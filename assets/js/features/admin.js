...
export function renderAdmin() {
    ...
    if (appState.currentUser?.role?.code === "teacher") {
    ...
    adminSection.innerHTML = `
        <article class="section-panel">
            ...
            <div class="heroes-journey__meta">
                ...
                ${renderOrganismeStatCard(stats.quiz_average === null || stats.quiz_average === undefined ? "—" : stats.quiz_average, t("organisme_stats_quiz_average"))}
            </div>
...
function exportOrganismeDashboard() {
    ...
    const lines = [
        ...
        `${t("organisme_stats_quiz_average")} : ${stats.quiz_average === null || stats.quiz_average === undefined ? "—" : stats.quiz_average}`,
        "",
