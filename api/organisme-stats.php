...
try {
    ...
    jsonSuccess([
        'stats' => $organismeRepository->getOrganismeStats((int) $organismeId),
        'popular_modules' => $organismeRepository->getPopularModules((int) $organismeId),
    ]);
    ...
    jsonError('Unable to load organisme stats.', 500);
}
